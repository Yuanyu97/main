...
TeaPet which aims to provide a centralised platform for couriers to easily manage their deliveries. TeaPet is
significantly different from Address Book 3 (AB3). In addition to the existing basic features of AB3, we needed to add
additional features to satisfy the needs of our target audience, couriers. Features that are unique to TeaPet are
